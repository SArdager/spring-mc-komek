package kz.kdlolymp.springmckomek.config;
...
//    }
    ...
    @Bean
    public CenterService centerService() { return new CenterService(); }
    @Bean
    ...
    @Bean
    public DoctorService doctorService() { return new DoctorService(); }
    @Bean
    public SpecialityService specialityService() { return new SpecialityService(); }
